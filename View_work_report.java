...
public class View_work_report extends Activity implements OnItemSelectedListener,OnItemClickListener {
	   Spinner s1;
	    Button b1;
	    ListView lv;
	    ...
	    ArrayList<String> eid,name,wr_id,title,report,date,wid,location;
	        ...
	        b1.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View view) {
	                ...
	                try {
	                    ...
	                    url = "http://" + ip + ":5000/mh_view_report";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.view_work_report, menu);
		return true;
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
		 ...
		 reports=report.get(arg2);
		  AlertDialog.Builder alert = new AlertDialog.Builder(View_work_report.this);
	        ...
	        alert.setNegativeButton("Send", new DialogInterface.OnClickListener() {
	            public void onClick(DialogInterface dialog, int whichButton) {
	            	...
	            	try
					{
						url="http://" + ip + ":5000/send_report";
						Toast.makeText(getApplicationContext(),url,Toast.LENGTH_LONG).show();

						List<NameValuePair> params=new ArrayList<NameValuePair>();
						
						params.add(new BasicNameValuePair("hid",sh.getString("id", "")));
						params.add(new BasicNameValuePair("work_id",wid.get(pos)));
