...
public class MH_view_profile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mh_view_profile);
		...
		b2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try
				{
				url="http://"+ip+":5000/mh_delete_profile";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mh_view_profile, menu);
		return true;
	}
