...
public class MH_view_admin_work extends Activity implements OnItemClickListener{
	ListView l1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mh_view_admin_work);
		ListView l1= (ListView)findViewById(R.id.listview5);
        sh=PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        ip=sh.getString("ip","");
        hid=sh.getString("id","");
        
        url="http://"+ip+":5000/mh_view_admin_work";
