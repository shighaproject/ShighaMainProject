...
public class Viewwork extends Activity implements OnItemClickListener{
	ListView l1;
	        ...
	        try {
	          ...
	          title = new ArrayList<String>(ar.length());
	           ...
	           work = new ArrayList<String>(ar.length());
	            ...
	            l1.setAdapter(new Custom(this,title,location,work));
	 ...
	 @Override
	  ...
	  @Override
		public boolean onCreateOptionsMenu(Menu menu) {
		  ...
		  getMenuInflater().inflate(R.menu.viewwork, menu);
			return true;
		}
		@Override
		...
		//	 reports=report.get(arg2);
			  AlertDialog.Builder alert = new AlertDialog.Builder(Viewwork.this);
		        ...
		        alert.setNegativeButton("Send report", new DialogInterface.OnClickListener() {
		            public void onClick(DialogInterface dialog, int whichButton) {
		            	...
		            	Intent i=new Intent(getApplicationContext(),Send_report.class);
