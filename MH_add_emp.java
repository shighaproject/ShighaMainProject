...
public class MH_add_emp extends Activity implements OnItemClickListener {
	Button b1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mh_add_emp);
		...
		b1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(getApplicationContext(),MH_register_employee.class);
...
url="http://"+sh.getString("ip", "")+":5000/mh_view_employee";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mh_add_emp, menu);
		return true;
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// TODO Auto-generated method stub
		Intent i=new Intent(getApplicationContext(),MH_view_profile.class);
