...
public class Cust2 extends BaseAdapter{
    ...
    String ip="";
    public Cust2(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_cust2,null);
