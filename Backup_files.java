...
public class Backup_files extends Activity {

    public static Button btsave,btmarkall,btunmarkall;
    ListView l1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btmarkall = (Button) findViewById(R.id.button1);
        btunmarkall=(Button) findViewById(R.id.button3);


        sp= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        btmarkall.setVisibility(View.VISIBLE);
        ...
        try {
        String url = "http://" + sp.getString("ip","") + ":5000/FileView";
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("imei",sp.getString("imei", "")));
        JSONArray json =(JSONArray) jsonParser.makeHttpRequest(url, "GET", params);
            ...
            l1.setAdapter(new Request_adapter(getApplicationContext(), file));
        ...
        btmarkall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                l1.setAdapter(new MarkallAdapter(getApplicationContext(), file));

                btunmarkall.setVisibility(View.VISIBLE);
            }
        });

        btunmarkall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                l1.setAdapter(new UnmarkallAdapter(getApplicationContext(), file));
                btmarkall.setVisibility(View.VISIBLE);
                //	btunmarkall.setVisibility(View.GONE);
    ...
    protected void InsertRequest(String s)
    {
        try {
            ...
            String url="http://"+sp.getString("ip","")+":5000/InsertBackup";
            List<NameValuePair> params = new ArrayList<NameValuePair>();
