...
public class Employee_reg extends Activity  implements OnItemSelectedListener{
	Spinner s1;
...
//				
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.employee_reg, menu);
		return true;
	}
...
//				    
	...
	public int uploadFile(String sourceFileUri) {
		...
		String upLoadServerUri ="http://"+ip+":5000/tl_register"; 
